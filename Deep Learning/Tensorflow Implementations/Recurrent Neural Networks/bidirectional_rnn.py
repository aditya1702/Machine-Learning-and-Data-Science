...
class Model:
    ...
    def prediction(self):
        ...
        outputs, _, _ = rnn.static_bidirectional_rnn(lstm_forward_cell, lstm_backward_cell, data_unstacked, dtype=tf.float32)
...
def main():
    ...
    while step * batch_size < training_iters:
        ...
        if step % display_step == 0:
            ...
            # loss = sess.run(model.optimize.cost, feed_dict={image: batch_x, label: batch_y})
